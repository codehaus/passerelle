...
public class StringConvertorTest extends TestCase {
    ...
    private static final String convertPathDelims = "blablbealjbf" + File.separatorChar +
    		"7834thiure" + File.separatorChar +
    		"iu3r5irf" + File.separatorChar +
    		"iuwerguier" + File.separatorChar + File.separatorChar + File.separatorChar +
    		"blablabla" + File.separatorChar + File.separatorChar +
