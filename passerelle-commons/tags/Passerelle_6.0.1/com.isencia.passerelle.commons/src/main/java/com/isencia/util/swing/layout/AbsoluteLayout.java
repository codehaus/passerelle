...
* allow placement of be.isencia.util.swing.components in absolute positions.
*
...
public class AbsoluteLayout implements LayoutManager2, java.io.Serializable {
    ...
    * panel given the be.isencia.util.swing.components in the specified parent container.
    ...
    * be.isencia.util.swing.components.  The value should be a number between 0 and 1
