...
public class ClassPath {
    ...
    /**
     * Builds a classpath containing all .jar and .zip files 
     * in the given folder and all its sub-folders.
     * @param dir
     */
    ...
    /**
     * Builds a classpath containing all files in the
     * given folder and in all its sub-folders, 
     * with names matching the given regular expression filter pattern.
     * 
     * @param dir
     * @param filter
     */
