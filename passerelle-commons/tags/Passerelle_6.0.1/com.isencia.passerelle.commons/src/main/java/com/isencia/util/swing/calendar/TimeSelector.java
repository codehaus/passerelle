 ...
 * @author  Kai Toedter
 */
public class TimeSelector extends JPanel implements 
AdjustmentListener, DocumentListener {
    /**
    ...
    public void adjustmentValueChanged(AdjustmentEvent e) {
    	...
    	if (currentValue <previousValue){
    		...
    		if (lastPressedButton == 1){	//UP
        		if (i<100) countKeyPressedButton++;
        		else countKeyPressedButton=0;
        	}else countKeyPressedButton=0;
...
class TimeTextField extends JTextField implements KeyListener {
	 ...
	 * Default constructor
	 * 
	 * set the time at the current time with 24h format eg: 23:45:35
	 * 
	 */
	 ...
	 * @param precisiontype = PRECISION_HOURS,PRECISION_MINUTES,PRECISION_SECONDS
	 * @param precision = precision of the printed time eg:5
	 * 
	 * eg : initval="09:55 PM" format = FORMAT_12H 
	 * 		precisiontype = PRECISION_MINUTES precision=5
	 * 
	 */
   ...
   /**
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_UP) {
        	if (lastPressedKey == KeyEvent.VK_UP){	
        		if (i<100) countKeyPressed++;
        		else countKeyPressed=0;
        	}else countKeyPressed=0;
	...
	/**
	 * returns the format of the time according to the specified precisionformat and timeformat
	 */
	...
	private int getJump(int offs){
		...
		switch (format) {
			case FORMAT_12H :
				switch (precisionType) {
					case PRECISION_SECONDS :
						if (offs==1 || offs==4 || offs==7) jump=2;
						else if(offs==9) jump=0;
						break;
					case PRECISION_MINUTES :
						if (offs==1 || offs==4 ) jump=2;
