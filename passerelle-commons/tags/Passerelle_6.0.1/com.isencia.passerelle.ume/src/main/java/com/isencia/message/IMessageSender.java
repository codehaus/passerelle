...
/**
 * Interface for message senders, implemented using one or more
 * sender channels.
 * 
 * Depending on the message sender implementation, it could
 * for example send out each message on ALL channels, use
...
public interface IMessageSender {
	 ...
	 * 
	 * @param channel the channel that should be removed from the sender's operations
	 * @return boolean true if the Channel was registered with the sender
