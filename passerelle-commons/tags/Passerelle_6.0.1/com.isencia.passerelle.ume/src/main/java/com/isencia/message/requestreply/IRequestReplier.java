...
public interface IRequestReplier {
    ...
    /**
     * Gets a message from the receiver, and removes it from the receiver
     * internal message queue.
     * Blocking method, waits until a message is available.
     *
     * @return a message
    ...
    /**
     * Sends a message in response to a received request msg, which
     * is identified with the correlationID parameter.
     * 
     * The IRequestReplier will find out itself where the 
     * response must be sent to, using the correlationID as lookup key.
     * 
     * @param message
     ...
     * 
     * @param channelPair 
     * @return boolean true if the channel pair was registered 
