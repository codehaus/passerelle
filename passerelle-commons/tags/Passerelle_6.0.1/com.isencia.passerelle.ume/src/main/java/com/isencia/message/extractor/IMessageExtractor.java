...
public interface IMessageExtractor {
	...
	/**
	 * Consecutive calls to getMessage() will sequentially feed 
	 * character data to the strategy's data buffer.
	 * The return object will be null for all intermediate calls,
	 * and will contain the complete message when an end of message is found.
	 *
    ...
    /**
     * Creates a clone of the given extractor.
