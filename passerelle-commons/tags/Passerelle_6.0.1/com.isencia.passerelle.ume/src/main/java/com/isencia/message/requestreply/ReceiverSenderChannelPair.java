...
/**
 * Simple container for a pair of a receiver and a sender channel.
 * Useful, e.g. for request-reply semantics, where we need to be able
 * to maintain knowledge about which sender channel to use for
 * sending a reply to a msg received via a certain receiver channel.
 *
 * @author erwin
 */
public class ReceiverSenderChannelPair implements IRequestReplyChannel {
    ...
    public void open() throws ChannelException {
        ...
        try {
            ...
            try {getReceiverChannel().close();} catch (ChannelException e1) {}
            throw e;
        }
    }
    ...
    /**
     * BEWARE: this method returns just the message contents,
     * no correlation info.
     */
