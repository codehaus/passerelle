...
public class StringConvertor {
    ...
    /**
     * This method returns the input string with the first character converted
     * to lower case.
     * 
     * @param string
     *            java.lang.String
    ...
    /**
     * Replaces forward\backward slashes in a string with the
     * desired path separator character for the current platform.
     * 
    ...
    public static Boolean stringToBoolean(String a) {
        ...
        c = a.charAt(0);
        return new Boolean(c == 'y' || c == 'Y' || c == '1' || c == 't'
                || c == 'T');
    }
     ...
     * value.
     * All sequences ${any.sys.prop.name} that are encountered, are replaced by the
     * value for the system property with the respective name.
     * 
     * @return java.lang.String
     * @param aString
     *            java.lang.String
    ...
    public static String substituteSystemProperties(String aString) {
        ...
        java.util.StringTokenizer st = new java.util.StringTokenizer(aString,
                "$", true);
        ...
        try {
            while (st.hasMoreTokens()) {
                ...
                if (t.equals("$")) {
                    ...
                    substrStart = tmpStrB.toString().indexOf(
                            "${" + sysPropName + "}", substrEnd);
                    // +3 for the ${ and }
                    substrEnd = substrStart + sysPropName.length() + 3; 

                    tmpStrB = tmpStrB.replace(substrStart, substrEnd,
                            sysPropValue);
                    substrEnd = substrEnd + sysPropValue.length()
                            - sysPropName.length() - 3;
                }
            }
