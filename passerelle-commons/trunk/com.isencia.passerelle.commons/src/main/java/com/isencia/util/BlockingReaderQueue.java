...
public class BlockingReaderQueue extends BlockingQueue {
	...
	public boolean put(Object o) {
        if (logger.isTraceEnabled())
            logger.trace("put() - entry - Putting :"+o);
        ...
        if (logger.isTraceEnabled())
            logger.trace("put() - exit - Returning :"+res);
		return res;
	}
	...
	public Object get() throws EmptyQueueException {
		...
		if(logger.isTraceEnabled())
			logger.trace("get() - exit - Returning :"+res);
		return res;
	}

	/**
	 * Get an element from the queue. If it is empty wait at most timeout milliseconds.
	 * 
	 * @param timeout
	...
	public Object get(long timeout) throws EmptyQueueException {
		if(logger.isTraceEnabled())
			logger.trace("get() - entry - timeout :"+timeout);
