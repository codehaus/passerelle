...
public class LoadImage {
	 ...
	 *  2) at the directory ../be.isencia.util.swing.images
	 *  3) at the directory ./be.isencia.util.swing.images
	 *  
	 *  new for this Version is the use of a URL, so be.isencia.util.swing.images can be
	 *  loaded over the net
	 **/
	...
	String url2=null, url3=null;
		...
		url2   = LoadImage.class.getResource(".."
			+ File.separator + "be.isencia.util.swing.images"
