...
/**
 * Receiver channels encapsulate different incoming protocols/technologies.
...
public interface IReceiverChannel extends Runnable {
	...
	/**
	 * Obtain the collection of IMessageListeners registered
	 * with this channel.
	...
	/**
	 * Returns the next message from the channel's data source.
	 * returns the message if One was found, null otherwise.
	 * 
	 * @return Object. 
	 ...
	 * 
	 * The interceptors will receive the message right before it leaves the channel.
	 * After that, the channel will deliver the message to its listeners 
