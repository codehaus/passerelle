 ...
 * Implementations are often asynchronous and then use a 
 * blocking queue to store all incoming messages from a number of 
...
public interface IMessageReceiver extends IMessageListener {
	 ...
	 * @return boolean true if the channel was registered with the receiver
