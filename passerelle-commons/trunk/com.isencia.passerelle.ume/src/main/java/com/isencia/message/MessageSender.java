...
public class MessageSender implements IMessageSender {
	 ...
	 * @throws InterruptedException If the thread is interrupted during a put() on the queue.
	 * 
	...
	/**
	 * Get the first message from the msg queue.
	 * The queue.get() is a blocking call, returning when a msg
	 * is available on the queue.
	 * After calling close(), getMessage() will only call on the
	 * queue if it is non-empty. Once it is empty, getMessage() returns null.
	 * 
	 * @return Object the first message from the queue
	 * 
	 * @throws NoMoreMessagesException if the queue is empty
	 * @throws InterruptedException If the thread is interrupted 
	 * during the blocking get() on the queue.
	 */
	...
	/*
	 *  (non-Javadoc)
	 * @see be.isencia.message.IMessageSender#isOpen()
	 */
