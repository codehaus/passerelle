...
//		this property should be set externally, e.g. in jre/lib/jaxp.properties or using some other means
...
//		System.getProperties().put("javax.xml.parsers.SAXParserFactory","org.apache.xerces.jaxp.SAXParserFactoryImpl");
	...
	/*
	 * @see IMessageExtractor#acceptData()
	 */
