...
public class FileWriter extends ChannelSink {
	...
	/**
	 * @see be.tuple.passerelle.engine.actor.ChannelSink#openChannel()
	 */
	 ...
	 */
//	protected void createPaneFactory() throws NameDuplicationException, IllegalActionException {
//		PaneFactoryCreator.createPaneFactory(this,be.isencia.passerelle.actor.gui.pane.custom.FileWriterParamEditPane.class);
//	}
