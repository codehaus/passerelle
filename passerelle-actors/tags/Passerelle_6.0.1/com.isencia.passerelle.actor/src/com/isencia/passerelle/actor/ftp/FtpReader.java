...
public class FtpReader extends TriggeredChannelSource {
	...
	private static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(FtpReader.class);
	 ...
	 */
	public FtpReader (CompositeEntity container, String name)
	throws IllegalActionException, NameDuplicationException {
		...
		// CREATE IMAGE
		//Copied from be.isencia.passerelle.actor.flow.Switch
	...
	/**
	 * @see be.tuple.passerelle.engine.actor.ChannelSink#createSendChannel()
	 */
	protected IReceiverChannel createChannel() {
		IReceiverChannel res = null;
		res = new FtpReceiverChannel(new File(file),server,user,password,
				isBinaryTransfer,isPassiveMode, new TextLineMessageExtractor());
		return res;
	}
