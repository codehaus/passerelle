...
public class FtpWriter extends ChannelSink {
	 ...
	 */
	public FtpWriter (CompositeEntity container, String name)
	...
	protected ISenderChannel createChannel() {
		...
		res = new FtpSenderChannel(file,server,user,password,
				isBinaryTransfer,isPassiveMode, new MessageTextLineGenerator());
		return res;
	}
