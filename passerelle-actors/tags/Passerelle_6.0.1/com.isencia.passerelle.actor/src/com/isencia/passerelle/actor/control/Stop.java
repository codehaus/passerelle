...
//// Stop
/**
 * SLIGHT VARIATION ON THE PTOLEMY STOP ACTOR, FOR PASSERELLE:
 * STOPS MODEL EXECUTION ON RECEIVING ANY KIND OF MESSAGE,
 * NOT JUST TRUE TOKENS...
...
public class Stop extends Sink {
    ...
    protected void sendMessage(ManagedMessage outgoingMessage) throws ProcessingException {
        ...
        if (container instanceof CompositeActor) {
            ...
            throw new ProcessingException("Cannot stop without a container that is a "
                    + "CompositeActor.", this, null);
        }
    }
