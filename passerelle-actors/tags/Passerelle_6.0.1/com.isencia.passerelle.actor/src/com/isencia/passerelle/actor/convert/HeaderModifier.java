...
/**
 * Simple actor that reads std passerelle msgs
 * and allows to add a property name/value pair to it.
 * 
 * @version 	1.0
...
public class HeaderModifier extends Transformer {
	 ...
	 */
	public HeaderModifier(CompositeEntity container, String name)
