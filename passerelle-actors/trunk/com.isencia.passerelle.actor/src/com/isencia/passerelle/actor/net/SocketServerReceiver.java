...
public class SocketServerReceiver extends ChannelSource {
    ...
    ///////////////////////////////////////////////////////////////////
    ////                         private variables                 ////
    private static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(SocketServerReceiver.class);
     ...
     */
    public SocketServerReceiver(ptolemy.kernel.CompositeEntity container, String name)
