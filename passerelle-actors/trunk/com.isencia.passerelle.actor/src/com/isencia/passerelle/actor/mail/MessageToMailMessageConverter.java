...
public class MessageToMailMessageConverter implements IMessageInterceptor {
	...
	/**
	 * @see be.tuple.message.interceptor.IMessageInterceptor#accept(Object, Object)
	 */
	public Object accept(Object message) throws Exception {
		...
		if (toRecipients != null && toRecipients.length > 0) {
			...
			mailMessage.setRecipients(
				javax.mail.Message.RecipientType.TO,addresses);
		}
		...
		if (ccRecipients != null && ccRecipients.length > 0) {
			...
			mailMessage.setRecipients(
				javax.mail.Message.RecipientType.CC,addresses);
		}
		...
		if (bccRecipients != null && bccRecipients.length > 0) {
			...
			mailMessage.setRecipients(
				javax.mail.Message.RecipientType.BCC,addresses);
		}
