...
/**
 * A Passerelle extension to the std Ptolemy ProcessThread
 ...
 * 
 * <p>
 * implementation remark : updated to ptolemy 7.0.1, but ignoring
 * their FiringsRecordable stuff, as it seems to be incomplete anyway.
 * I.e. it's not compatible with the more complete event logging
 * in ...Actor.iterate(). 
 * So we just maintain our own FiringEvent handling for now.
 * </p>
 * 
 * @author erwin dl
 */
public class ProcessThread extends ptolemy.actor.process.ProcessThread {
	...
	public void run() {
        ...
        try {
            ...
            while (iterate) {
            	...
            	// check for synchronization/stepping/... of this actor's iterations
    ...
    // a simple cache for all event types, so we don't need to construct new ones for every iteration
