...
/**
 * Base class for all Passerelle Sinks that use a  be.tuple.message.ISenderChannel. Sub-classes must implement createChannel(), returning a completely defined
