...
public class HelpAttributeHandler extends AbstractHandler implements IViewActionDelegate, ISelectionListener {
	...
	private void doAction() {
		...
		try {
			attView.showHelpSelectedParameter();
		} catch (IllegalActionException e) {
			logger.error("Cannot show help parameter ", e);
		}
	}
