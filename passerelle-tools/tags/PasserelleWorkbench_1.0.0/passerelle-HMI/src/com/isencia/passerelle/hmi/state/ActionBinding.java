...
class ActionBinding extends ActionEnabler{
	...
	/**
	 * Returns <code>true</code> if this <code>ActionBinding</code> is the same as the o argument.
	 *
	 * @return <code>true</code> if this <code>ActionBinding</code> is the same as the o argument.
	 */
