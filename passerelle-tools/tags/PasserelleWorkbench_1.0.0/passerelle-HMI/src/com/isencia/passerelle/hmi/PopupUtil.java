...
public class PopupUtil {
	...
	public static void showError(Component container, String resourceMessage, String additionalInfo) {
		showOptionDialog(container,
                HMIMessages.getString(resourceMessage)+ (additionalInfo!=null?"\nInfo:"+additionalInfo:""),
	...
	public static int showConfirmDialog(Component parentComponent, Object message,
             String title, int optionType,int messageType, int width, int height) {
		return showOptionDialog(parentComponent, message, title, optionType,
				messageType, null, null, null, width, height);
	}
    ...
    public static int showOptionDialog(Component parentComponent, Object message,
    	...
    	return showOptionDialog(parentComponent, message, title, optionType, messageType,
    			icon, options, initialValue, width, height);
    }
        	 
    public static int showOptionDialog(Component parentComponent, Object message,
            String title, int optionType,
            int messageType, Icon icon,
            Object[] options, Object initialValue, int width, int height) {
