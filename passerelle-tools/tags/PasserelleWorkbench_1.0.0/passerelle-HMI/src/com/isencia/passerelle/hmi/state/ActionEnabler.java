...
abstract class ActionEnabler {
	...
	/**
	 * Returns <code>true</code> if this <code>ActionEnabler</code> is the same as the o argument.
	 *
	 * @return <code>true</code> if this <code>ActionEnabler</code> is the same as the o argument.
	 */
