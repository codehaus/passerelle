...
class ActionComponentBinding extends ActionEnabler{
	...
	/**
	 * Returns <code>true</code> if this <code>ActionComponentBinding</code> is the same as the o argument.
	 *
	 * @return <code>true</code> if this <code>ActionComponentBinding</code> is the same as the o argument.
	 */
