...
/**
 * A combination of a checkbox and another component
 * when the checkbox is on, the other component is shown
 * when it's off the other component disappears
 * 
 * An optional subject can be registered as well, so we can
 * easily link the check status with another arbitrary object.
 * 
 * @author erwin
 *
 */
